...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <a href="{{url('admin/add-edit-company')}}" style="float: right;"><button type="button" class="btn btn-success btn-sm">Add Company</button></a>
        <h6 class="mb-0 text-uppercase"> Medicine Company</h6>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$company['name']}}</td>
                                <td>
                                    <a href="{{url('admin/add-edit-company/'.$company['id'])}}">
                                    ...
                                    /
                                    <a href="{{url('admin/delete-company/'.$company['id'])}}">
