            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Medicine Categories</li>
                    </ol>
                </nav>
            </div>
        </div>
        <a href="{{url('admin/add-edit-category')}}" style="float: right;"><button type="button" class="btn btn-success btn-sm">Add Category</button></a>
