...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Strength</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Medicine Strength</li>
                    </ol>
                </nav>
            </div>
        </div>
        <a href="{{url('admin/add-edit-strength')}}" style="float: right;"><button type="button" class="btn btn-success btn-sm">Add Strength</button></a>
        <h6 class="mb-0 text-uppercase"> Medicine Strength</h6>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$strength['name']}}</td>
                                <td>
                                    <a href="{{url('admin/add-edit-strength/'.$strength['id'])}}">
                                    ...
                                    /
                                    <a href="{{url('admin/delete-strength/'.$strength['id'])}}">
